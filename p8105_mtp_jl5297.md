...
<img src="p8105_mtp_jl5297_files/figure-markdown_github/unnamed-chunk-3-1.png" width="80%" style="display: block; margin: auto;" /> However if we consider the effect of the time, we can see the smooth estimates of day total activity of each day accorss weeks are quite different. For example, from week 30 to 40, this participant tended to have higher day total activity on Saturday.
